...
local function build_ui_config(box_id)
  ...
  return {
    ...
    -- Optional sprite draw/update properties (rotation/tint/opacity/etc)
    properties = nil,
-- Text look/feel
...
Net:on("actor_interaction", function(event)
  ...
  PromptVertical.menu(player_id,{ui = build_ui_config("prog_vert_prompt_box"),layout= build_layout_config(),
